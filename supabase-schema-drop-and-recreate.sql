-- Pulse Trades Database Schema - Drop and Recreate
-- Run this in your Supabase SQL editor if you want to start fresh

-- Drop existing tables in reverse dependency order
DROP TABLE IF EXISTS prestige_badges CASCADE;
DROP TABLE IF EXISTS submissions CASCADE;
DROP TABLE IF EXISTS leaderboard_resets CASCADE;
DROP TABLE IF EXISTS users CASCADE;

-- Drop existing functions
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;
DROP FUNCTION IF EXISTS get_leaderboard(DATE) CASCADE;
DROP FUNCTION IF EXISTS get_user_stats(TEXT) CASCADE;
DROP FUNCTION IF EXISTS award_prestige_badge() CASCADE;
DROP FUNCTION IF EXISTS get_community_leaderboard(DATE, TEXT) CASCADE;
DROP FUNCTION IF EXISTS get_global_leaderboard(DATE) CASCADE;
DROP FUNCTION IF EXISTS reset_community_leaderboard(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS reset_global_leaderboard(TEXT) CASCADE;

-- Now run the updated schema
